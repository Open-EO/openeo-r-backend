...
install.packages(c("rgdal", "gdalUtils", "raster", "sodium", "plumber", "DBI", "RSQLite", "future", "httr", "httpuv", "tibble", "dplyr", "rgeos", "magrittr", "units", "sf", "lubridate"), repos = cran.mirror)
